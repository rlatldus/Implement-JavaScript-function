...
| :------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|<div>
  <img src="https://github.com/rlatldus/SVG_practice/assets/122216298/efa77994-61cc-4ef1-8d56-8b247187e1ea" style="width: 400px;" alt="SVGAnimation">
</div> | <h3 style="margin: 0;">A Simple SVG Walkthrough</h3> <h5>✨기능</h5> ▪️ 메인화면에 <b>간단한</b>효과를 구현합니다. <br><br>▪️ 줌을 하거나 크기를 변경할 때 SVG 이미지의 질은 떨어지지 않습니다. <br><br>▪️ IDE나 텍스트 편집기에서 SVG 이미지를 작성하고 수정할 수 있습니다.<br><br>▪️ 파일 크기는 작지만, 확장이 매우 용이합니다. |
...
|                                                           Result                                                           | Description                                                                                                                                                                                                                                                                                                                        |
| :------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div>![Animation](https://github.com/rlatldus/SVG_practice/assets/122216298/5a66dcd2-b91c-41e5-ac85-4bac5c9c7e6c)</div> | <h3 style="margin: 0;">Todo list</h3> <h5>✨기능</h5> 1️⃣ 입력할 수 있습니다. <br><br>▪2️⃣ 전체 삭제와 개별삭제가 가능합니다. <br><br>>3️⃣ 로컬스토리지에 저장하여 다시 페이지에 들어와도 그대로 정보가 남아이습니다. |
...
|                                                           Result                                                           | Description                                                                                                                                                                                                                                                                                                                        |
| :------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div>![Rock-Paper-Siser](https://github.com/rlatldus/SVG_practice/assets/122216298/f17a6bea-de82-4afd-9637-bba6e9a9ef77)</div> | <h3 style="margin: 0;">Rock-Paper-Scissors</h3> <h5>✨기능</h5> 1️⃣`Math.floor(Math.random() * 3)`을 사용하여 랜덤으로 컴퓨터의 가위바위보가 선택되도록 만들었습니다. <br><br>▪2️⃣ 내가 선택한 버튼과 랜덤으로 선택된 값을 비교하여 결과를 추출합니다. |
...
|                                                           Result                                                           | Description                                                                                                                                                                                                                                                                                                                        |
| :------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div>![Modal](https://github.com/rlatldus/SVG_practice/assets/122216298/16d70d40-a26d-4d14-b086-10736d14abdd)</div> | <h3 style="margin: 0;">Modal</h3> <h5>✨기능</h5> 1️⃣버튼을 클릭하면 창이 생성되고 닫기를 누르면 닫히는 모달 창을 만들었습니다. <br><br>▪2️⃣ 포인트는 한줄로 코드를 만들었습니다. |
...
|                                     
                      Result                                                           | Description                                                                                                                                                                                                                                                                                                                        |
| :------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div>![Clock](https://github.com/rlatldus/SVG_practice/assets/122216298/c62337f9-1329-49ef-a8c4-1080e8749a2c)</div> | <h3 style="margin: 0;">Modal</h3> <h5>✨기능</h5> 1️⃣Date()함수를 이용하여 만들었습니다. <br><br>▪2️⃣ Date함수를 이용하면 현재 시간의 정보를 추출할 수 있습니다. |
